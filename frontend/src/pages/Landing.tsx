...
const PLANS = [
  ...
  { name: "Enterprise", price: "$499", period: "/mo", tagline: "For large-scale deployments", features: ["Unlimited agents & teams", "Unlimited executions", "Custom integrations", "99.9% uptime SLA", "SSO / SAML"], cta: "Start Free Trial", highlight: false },
];
